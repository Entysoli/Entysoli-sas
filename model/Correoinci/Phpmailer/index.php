...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      // Enable verbose debug output
    ...
    $mail->addAddress('entornossoluciones@gmail.com', 'Joe User');     // Add a recipient
    ...
    $mail->Subject = 'Se ha registrado un incidente';
    $mail->Body    = 'Un usuario registró un incidente';
