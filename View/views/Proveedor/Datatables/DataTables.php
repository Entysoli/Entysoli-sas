...
if (isset($_POST['btnEdit'])) {
    ...
    $sqlupdate = "UPDATE proveedor set Nombre='$new_nom', Apellido='$new_tel', Direccion='$new_dir', Telefono='$new_es', Correo='$new_idp' where idProveedor='$new_id'";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sqldelete = "DELETE FROM proveedor where Cedula='$id'";
