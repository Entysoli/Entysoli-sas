                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="txtid">id Proveedor</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="txtes" name="txtes" value="<?php echo $est; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="txtid">Correo</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="txtidp" name="txtidp" value="<?php echo $idp; ?>" >
                            </div>
                        </div>
                    </div>
                </form>
